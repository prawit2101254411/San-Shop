           ...
           <SildebarForm session={session}/>
            <div className=' flex w-1/2 h-1/2 shadow-lg mt-10'>
                <div className='flex flex-col items-center justify-center h-full w-1/2 border-r'>
                    ...
                    <button type='button' className=' border p-1 text-sm rounded-lg'>Add Image</button>
                </div>
                <div className='flex flex-col h-full w-1/2 '>
                    <div className='flex justify-end '>
                        <a onClick={() => modal?.show(<EditProfileForm session={session} />)} ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor"
