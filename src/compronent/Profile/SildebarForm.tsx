        ...
        <div className='flex flex-col mr-2 border mt-10 '>
            ...
            <div className=' flex flex-col mt-4 '>
                ...
                <motion.a
                    ...
                    whileTap={{ scale: 0.90 }}
                    className='flex font-semibold ml-6 text-sm mt-2' >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-journal-text mr-2" viewBox="0 0 16 16">
                ...
                <motion.a
                    whileTap={{ scale: 0.90 }}
                    href='http://localhost:3000/app/login-shop'
                    className='flex font-semibold ml-6 mt-3 text-sm'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-shop-window mr-2" viewBox="0 0 16 16">
